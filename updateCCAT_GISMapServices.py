...
emailObj = EmailUtil("gis_data_update_process@somePlace.com", ["Warren.Kunkler@somePlace.com"])
...
class updateCCAT_GIS_MapServies:
    ...
    def __init__(self, rootDir):
        ...
        passWord = ""
        userName = ""
        self.Caggisrv01 = RestRequest(userName, passWord, "caggissrv01", 6080, self.rootDir + '\\CagSrv01.csv')
        self.Caggisrv03 = RestRequest(userName, passWord, "caggissrv03", 6080, self.rootDir + "\\CagSrv03.csv")
